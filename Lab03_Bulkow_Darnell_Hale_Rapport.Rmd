...
Assumption 4: 0 conditional mean/exogeneity
...
Write the model equation, and interpret direction and magnitude of coefficients.
...
supressWarnings(scatterplotMatrix(df_clean[,vars], diag = "histogram"))
```
